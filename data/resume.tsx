...
export const DATA = {
  ...
  description:
    "Full-Stack Developer specializing in Next.js, enterprise tools, and end-to-end delivery.",
  avatarUrl: "/me.png",
  skills: [
    ...
    { name: "Observability", icon: ChartNoAxesCombined },
    { name: "LeanIX", icon: FileText },
  ],
  contact: {
